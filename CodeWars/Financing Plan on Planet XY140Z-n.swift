...
// This can be solved in a single line of code versus a nested loop, but in all honesty if I wasn't told to solution, I'm unlikely to have solved it so simply.
